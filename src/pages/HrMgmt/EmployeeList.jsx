...
import { Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Button, Flex, HStack, IconButton, Img, Input, InputGroup, Select, Spinner, Table, Tbody, Td, Text, Th, Thead, Tooltip, Tr } from "@chakra-ui/react";
...
const handleDelete = (id) => {
           ...
           <Flex justifyContent="space-between" mb={4} alignItems='baseline'>
                ...
                <Box bg="white" borderRadius="md" boxShadow="sm" overflowX="auto" border="1px solid #e5e5e5" >
                    {loading ? (
                        ...
                        <Table variant="striped" colorScheme="gray" size="sm" width="1950px" className="productsTable">
                          <Thead>
                    <Tr>
                      {["Name", "Email","Department", "Role", "Contact", "City / State", "Salary(Rs.)", "DOJ", "Leaves", "Login", "Logout", "Approver", "Action"].map((header, index) => (
                        <Th key={index} fontSize='14px' fontWeight='500' color='#2C2D33' textTransform='capitalize'
                          width={header === "Name" ? "8%" : "auto" && header === "Role" ? '12%' : 'auto' && header === "Login"? "8%": 'auto'} borderColor='#D9D9D9'
                        >
  ...
  <Flex justify="space-between" align="center">
    ...
    <Flex align="center">
      ...
      <Text ml={2} fontSize="14px" color="#666">
        of {totalPages} pages
      </Text>
