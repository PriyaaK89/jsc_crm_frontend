          ...
          {isLoading ? (
            ...
            <VStack spacing={4} align="stretch">
              {notifications.map((item) => {
                ...
                // extractAfterKeyword( item.message, "generated by", );

                const soNumber = buildSalesOrderNumber(
                  item.generated_by_id,
                  item.id,
                );
                ...
                return (
                  <Box
                    ...
                    <Box p={4}>
                      ...
                      <Text fontSize="12px" color="gray.700" lineHeight="1.8">{item?.message} {" "}
                        {/* {employeeName ? (
                          <>
                            Sales request generated by{" "} <Text as="span" fontWeight="700" color="gray.900"> {employeeName} </Text> .{" "}
                          </>
                        ) : (
                          `${item.message} `
                        )} */}
