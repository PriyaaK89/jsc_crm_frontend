...
const DeleteAssignTarget = ({ isDeleteModalOpen, onDeleteModalClose, selectedId, getTargetList}) => {
    ...
    const handleDeleteTarget  = async()=>{
        try{
              const response = await API?.delete(`${API_ENDPOINTS?.delete_assigned_targets}/${selectedId}`);
        ...
        <Modal isOpen={isDeleteModalOpen} onClose={onDeleteModalClose} isCentered >
            ...
            <ModalContent mx="12px" borderRadius="12px">
                ...
                <Flex bg="#E53E3E" borderRadius="12px 12px 0px 0px " color="white" py={2} px={4} justify="space-between" alignItems="center" size="xl">
                    <Text fontWeight="bold"> Delete Assign Target </Text>
                ...
                <ModalBody mt={4}>
                    <Text fontSize={{ base: "12px", md: "14px" }}>
                        ...
                        <b style={{ color: "red" }}>delete</b> this Assign Target?
                        <br />
...
export default DeleteAssignTarget
