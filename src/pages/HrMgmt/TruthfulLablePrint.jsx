    ...
    <Box bg="white" p={6} borderRadius="lg">
      ...
      <Box as="form" onSubmit={handleSubmit}>
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={5}>
          ...
          <FormControl>
            <FormLabel>GERMINATION (MIN) No.</FormLabel>
            <Input type="number" name="germination" placeholder="" min={0} max={100} onChange={handleChange} />
          ...
          <FormControl>
            <FormLabel>PHYSICAL PURITY (MIN) No.</FormLabel>
            <Input type="number" name="physicalPurity" placeholder="" min={0} max={100} onChange={handleChange} />
            {formData.germination > 100 && (
              <FormErrorMessage>Germination cannot exceed 100%</FormErrorMessage>
            )}
          </FormControl>
          ...
          <FormControl>
            <FormLabel>GENETIC PURITY (MIN) No.</FormLabel>
            <Input type="number" name="geneticPurity" placeholder="" min={0} max={100} onChange={handleChange} />
            {formData.germination > 100 && (
              <FormErrorMessage>Germination cannot exceed 100%</FormErrorMessage>
            )}
          </FormControl>
          ...
          <FormControl>
            ...
            <Input name="netQty" type='number' placeholder="Enter net qty in number" onChange={handleChange} />
          </FormControl>

          <FormControl>
            <FormLabel>MOISTURE (MAX) No.</FormLabel>
          ...
          <FormControl>
            ...
            <Input name="lotNo" placeholder="Enter moisture in number" onChange={handleChange} />
          </FormControl>
          ...
          <FormControl>
            ...
            <Input name="treatedWith" placeholder="Enter treated name " onChange={handleChange} />
          </FormControl>
      ...
      <Modal isOpen={isOpen} onClose={onClose} size="xl">
        ...
        <ModalContent>
          ...
          <ModalFooter justifyContent="center" gap={4}>
            ...
            <Button colorScheme="blue" onClick={() => { const iframe = document.querySelector("iframe"); iframe.contentWindow.print(); }} > Print </Button> 
            {/* DOWNLOAD BUTTON */} 
