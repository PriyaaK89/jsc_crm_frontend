...
import EmpPaymentHold from "../../../pages/HrMgmt/EmpPaymentHold";

const EmPaymentHoldLayout = () => {
    return (
                ...
                <Box bg="white" mt={{ base: 2, md: 5 }} px={{ base: 3, md: 6 }} py={{ base: 3, md: 4 }} borderRadius="lg" boxShadow="md">
                    <HStack justifyContent="space-between">
                        <Breadcrumb color="#8B8D97" padding="10px 0px 1rem 0px">
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbLink color="#8B8D97" fontSize="13px"> Employee Payment Hold </BreadcrumbLink>
                            </BreadcrumbItem>
                        </Breadcrumb>
                    </HStack>

                    <Text className="action_heading" mb={6} textAlign="center"> Hold Payment </Text>
                    <EmpPaymentHold/>
                </Box>
            </Box>
        </Box>
...
export default EmPaymentHoldLayout