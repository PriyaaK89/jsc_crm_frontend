...
import Journal from "../../../pages/TransactionMaster/Journal";

const JournalTxnMasterLayout = () => {
    return (
        <Box bg="#f2f1f1" minH="100vh" >
            ...
            <Box ml={{ base: 5, md: "295px" }} mr={{ base: 5, md: 5 }} pt="5rem" pb={6} >
                ...
                <Box bg="white" mt={{ base: 2, md: 5 }} px={{ base: 3, md: 6 }} py={{ base: 3, md: 4 }} borderRadius="lg" boxShadow="md">
                    ...
                    <Text className="action_heading" mb={6} textAlign="center"> Journal </Text>
                    <Journal/>
...
export default JournalTxnMasterLayout