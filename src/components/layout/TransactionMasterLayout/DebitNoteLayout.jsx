...
const DebitNoteTxnMasterLayout = () => {
    ...
    const loadVoucherNo = async () => {
        try {
            const res = await API.get( `${API_ENDPOINTS.GET_NEXTVOUCHER_NO}?voucher_type=DEBIT_NOTE` );
                ...
                <Box bg="white" mt={{ base: 2, md: 5 }} px={{ base: 3, md: 6 }} py={{ base: 3, md: 4 }} borderRadius="lg" boxShadow="md">
                    <HStack justifyContent="space-between">
                        <Breadcrumb color="#8B8D97" padding="10px 0px 1rem 0px">
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbLink color="#8B8D97" fontSize="13px"> Generate Debit Note </BreadcrumbLink>
                            </BreadcrumbItem>
                        </Breadcrumb>
                    </HStack>

                    <Text className="action_heading" mb={6} textAlign="center"> Generate Debit Note </Text>
