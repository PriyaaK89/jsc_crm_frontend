...
const CreditNoteNotificationModal = ({ isOpen, onClose, onViewOrder }) => {
  ...
  const fetchNotifications = async () => {
    setIsLoading(true);
    try {
      const res = await API.get(`${API_ENDPOINTS.GET_ORDER_NOTIFICATIONS}?module_type=CREDIT_NOTE&notification_category=APPROVAL`,);
            ...
            {isLoading ? (
              ...
              <Center py={14}>
                <Box textAlign="center">
                  <Text fontWeight="600" color="gray.700"> No credit note notifications </Text>
              ...
              <VStack spacing={4} align="stretch">
                {notifications.map((item) => {
                  ...
                  const creditNoteNumber = buildSalesOrderNumber( item.generated_by_id, item.order_no, );
                      ...
                      <Box p={4}>
                        ...
                        <Text fontSize="12px" color="gray.700" lineHeight="1.8">
                          ...
                          <Text
                            ...
                            <Link to={`/order-voucher/credit-note/${item.approval_id}`}>
                              {creditNoteNumber}
                            </Link>
                          </Text>{" "}
                          ({formatDate(item.created_at)}) to review the credit
                          note voucher.
                        </Text>
...
export default CreditNoteNotificationModal;