...
import ViewRetailerList from "../../../pages/Misc/ViewRetailerList";
import TransactionApproval from "../../../pages/Misc/TransactionApproval";

const TransactionApprovalLayout = () => {
    return (
        <>
...
export default TransactionApprovalLayout