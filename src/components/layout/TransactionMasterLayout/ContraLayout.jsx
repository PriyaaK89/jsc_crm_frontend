...
import Purchase from "../../../pages/TransactionMaster/Purchase";
...
import Contra from "../../../pages/TransactionMaster/Contra";

const ContraTxnMasterLayout = () => {
    return (
...
export default ContraTxnMasterLayout