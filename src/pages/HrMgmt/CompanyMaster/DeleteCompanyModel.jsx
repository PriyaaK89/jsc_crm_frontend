...
const DeleteCompanyModel = ({
  selectedId,
  isDeleteOpen,
  onDeleteClose, fetchDistributors
}) => {
  ...
  const handleDeleteEmployee = async () => {
    try {
      ...
      const res = await API.delete(
        `${API_ENDPOINTS.Delete_company}/${selectedId}`
      );

      if (res?.status === 200) {
        toast({
          title: "Company Deleted",
          description: "Comapny  has been deleted successfully.",
          status: "success",
          duration: 3000,
          isClosable: true,
        });
      ...
      <ModalContent mx="12px" borderRadius="12px">
        ...
        <ModalBody mt={4}>
          <Text fontSize={{base:"12px",md:"14px"}}>
            ...
            <b style={{ color: "red" }}>delete</b> this Comapny?
            <br />
