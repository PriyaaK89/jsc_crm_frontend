...
import EditStockItem from "../../../pages/InventoryMaster/EditStockItem";

const EditStockItemListLayout = () => {
                    ...
                    <Box bg="white" mt={{ base: 2, md: 5 }} px={{ base: 3, md: 6 }} py={{ base: 3, md: 4 }} borderRadius="lg" boxShadow="md">
                        ...
                        <HStack justifyContent="space-between">
                            <Breadcrumb color="#8B8D97" padding="10px 0px 1rem 0px" >
                                ...
                                <BreadcrumbItem>
                                    <BreadcrumbLink isCurrentPage color="#8B8D97" fontSize="13px"> Edit Stock Item </BreadcrumbLink>
                                </BreadcrumbItem>
                            </Breadcrumb>
                        </HStack>
                        <Heading size="md" color="gray.600" fontSize="18px" mt={3} > Edit Stock Item </Heading>
                        <Box> <EditStockItem/> </Box>
                    </Box>
...
export default EditStockItemListLayout