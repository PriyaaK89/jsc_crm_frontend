        ...
        <Modal isOpen={isOpen} onClose={onClose} size="5xl">
            ...
            <ModalContent  maxW="791px">
                <ModalBody p="0">
                   <Box id="joining-letter-preview" fontFamily="serif">
                       <Box className="pdf-page" >
                         ...
                         <VStack spacing={0} align="center" ml="1rem">
                           ...
                           <Text fontSize="18px" color="blue.700" fontWeight="bold">Seeds Production & Marketing Company</Text>
                           <Text fontSize="11px" color="green.800" mt="8px">North zone Office Add.-73 GANESH NAGAR-2, MURLIPURA JAIPUR, REG.OFFICE-105, NEMI CHAND MARKET ALWAR</Text>
                       ...
                       <Image src={r_logo} alt="Round Logo" className="watermark_img"/>
                         ...
                         <VStack align="flex-start" spacing={3}>
                           ...
                           <Text>
                             ...
                             the {employee?.department_name}. You will be based at{" "}
                   ...
                   <VStack>
                    <Button colorScheme="blue">Download Joining Letter</Button>
                   </VStack>
                </ModalBody>
            </ModalContent>
        </Modal>
